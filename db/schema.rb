...
ActiveRecord::Schema.define(version: 20170823230306) do
  ...
  create_table "cheat_foods", force: :cascade do |t|
    t.float    "servings"
    t.date     "day_of_cheat"
    t.integer  "user_id"
    t.integer  "foods_id"
  ...
  create_table "cheat_stats", force: :cascade do |t|
  ...
  create_table "foods_details", force: :cascade do |t|
